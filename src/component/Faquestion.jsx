    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10">
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <img
            src="https://i.ibb.co/WpBRFLmY/FAQtest2-927x1024-png.webp"
            alt="FAQ Illustration"
            className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-full h-auto rounded-xl shadow-lg"
          />
        </div>
        ...
        <div className="w-full lg:w-1/2">
          {faqData.map((item, index) => (
            ...
            >
              ...
              {openIndex === index && (
                <div className="px-5 pb-4 text-sm sm:text-base text-gray-700 bg-gray-50">
                  {item.answer}
                </div>
              )}
            </div>
